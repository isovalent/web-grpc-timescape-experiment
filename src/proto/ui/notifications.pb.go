...
func (x *Notification) GetAuthState() *AuthorizationState {
	if x, ok := x.GetNotification().(*Notification_AuthState); ok {
		return x.AuthState
	}
	return nil
}
...
type Notification_AuthState struct {
	AuthState *AuthorizationState `protobuf:"bytes,5,opt,name=auth_state,json=authState,proto3,oneof"`
}
...
func (*Notification_AuthState) isNotification_Notification() {}
...
type ConnectionState struct {
	...
	TimescapeConnected bool `protobuf:"varint,5,opt,name=timescape_connected,json=timescapeConnected,proto3" json:"timescape_connected,omitempty"`
	// Backend has lost the connection to hubble-timescape and is reconnecting now
	TimescapeReconnecting bool `protobuf:"varint,6,opt,name=timescape_reconnecting,json=timescapeReconnecting,proto3" json:"timescape_reconnecting,omitempty"`
}
...
func (x *ConnectionState) GetTimescapeConnected() bool {
	if x != nil {
		return x.TimescapeConnected
	}
	return false
}

func (x *ConnectionState) GetTimescapeReconnecting() bool {
	if x != nil {
		return x.TimescapeReconnecting
	}
	return false
}
...
func (x *AuthorizationState) Reset() {
	*x = AuthorizationState{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ui_notifications_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AuthorizationState) Descriptor() ([]byte, []int) {
	return file_ui_notifications_proto_rawDescGZIP(), []int{4}
}

func (x *AuthorizationState) GetInvalid() bool {
	if x != nil {
		return x.Invalid
	}
	return false
...
var file_ui_notifications_proto_rawDesc = []byte{
	...
	0x2f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa7, 0x02,
	...
	,
	...
	0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x2e, 0x0a, 0x12, 0x41, 0x75, 0x74,
	0x68, 0x6f, 0x72, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12,
	0x18, 0x0a, 0x07, 0x69, 0x6e, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x07, 0x69, 0x6e, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_ui_notifications_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_ui_notifications_proto_goTypes = []interface{}{
	...
	(*AuthorizationState)(nil), // 4: ui.AuthorizationState
	(*GetStatusResponse)(nil),  // 5: ui.GetStatusResponse
}
var file_ui_notifications_proto_depIdxs = []int32{
	...
	5, // 2: ui.Notification.status:type_name -> ui.GetStatusResponse
	3, // 3: ui.Notification.no_permission:type_name -> ui.NoPermission
	4, // 4: ui.Notification.auth_state:type_name -> ui.AuthorizationState
...
func file_ui_notifications_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_ui_notifications_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
