...
export interface Flow {
     ...
     */
    debug_capture_point: DebugCapturePoint;
    /**
...
export interface AgentEvent {
    ...
    notification: {
         ...
         */
        endpoint_regenerate: EndpointRegenNotification;
    } | {
        oneofKind: "endpoint_update";
        /**
...
export interface ServiceUpsertNotification {
     ...
     */
    backend_addresses: ServiceUpsertNotificationAddr[];
    /**
...
class Flow$Type extends MessageType<Flow> {
    constructor() {
        super("flow.Flow", [
            ...
            { no: 3, name: "drop_reason", kind: "scalar", localName: "drop_reason", T: 13 /*ScalarType.UINT32*/ },
            { no: 35, name: "auth_type", kind: "enum", localName: "auth_type", T: () => ["flow.AuthType", AuthType] },
            { no: 4, name: "ethernet", kind: "message", T: () => Ethernet },
            { no: 5, name: "IP", kind: "message", localName: "IP", jsonName: "IP", T: () => IP },
            { no: 6, name: "l4", kind: "message", T: () => Layer4 },
            { no: 8, name: "source", kind: "message", T: () => Endpoint },
            { no: 9, name: "destination", kind: "message", T: () => Endpoint },
            { no: 10, name: "Type", kind: "enum", localName: "Type", jsonName: "Type", T: () => ["flow.FlowType", FlowType] },
            { no: 11, name: "node_name", kind: "scalar", localName: "node_name", T: 9 /*ScalarType.STRING*/ },
            { no: 13, name: "source_names", kind: "scalar", localName: "source_names", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            ...
            { no: 19, name: "event_type", kind: "message", localName: "event_type", T: () => CiliumEventType },
            { no: 20, name: "source_service", kind: "message", localName: "source_service", T: () => Service },
            { no: 21, name: "destination_service", kind: "message", localName: "destination_service", T: () => Service },
            { no: 22, name: "traffic_direction", kind: "enum", localName: "traffic_direction", T: () => ["flow.TrafficDirection", TrafficDirection] },
            { no: 23, name: "policy_match_type", kind: "scalar", localName: "policy_match_type", T: 13 /*ScalarType.UINT32*/ },
            { no: 24, name: "trace_observation_point", kind: "enum", localName: "trace_observation_point", T: () => ["flow.TraceObservationPoint", TraceObservationPoint] },
            { no: 25, name: "drop_reason_desc", kind: "enum", localName: "drop_reason_desc", T: () => ["flow.DropReason", DropReason] },
            { no: 26, name: "is_reply", kind: "message", localName: "is_reply", T: () => BoolValue },
            { no: 27, name: "debug_capture_point", kind: "enum", localName: "debug_capture_point", T: () => ["flow.DebugCapturePoint", DebugCapturePoint] },
            { no: 28, name: "interface", kind: "message", T: () => NetworkInterface },
            { no: 29, name: "proxy_port", kind: "scalar", localName: "proxy_port", T: 13 /*ScalarType.UINT32*/ },
            { no: 30, name: "trace_context", kind: "message", localName: "trace_context", T: () => TraceContext },
            { no: 31, name: "sock_xlate_point", kind: "enum", localName: "sock_xlate_point", T: () => ["flow.SocketTranslationPoint", SocketTranslationPoint] },
            { no: 32, name: "socket_cookie", kind: "scalar", localName: "socket_cookie", T: 4 /*ScalarType.UINT64*/, L: 2 /*LongType.NUMBER*/ },
            { no: 33, name: "cgroup_id", kind: "scalar", localName: "cgroup_id", T: 4 /*ScalarType.UINT64*/, L: 2 /*LongType.NUMBER*/ },
            { no: 100000, name: "Summary", kind: "scalar", localName: "Summary", jsonName: "Summary", T: 9 /*ScalarType.STRING*/ },
            { no: 150000, name: "extensions", kind: "message", T: () => Any },
            { no: 21001, name: "egress_allowed_by", kind: "message", localName: "egress_allowed_by", repeat: 1 /*RepeatType.PACKED*/, T: () => Policy },
            { no: 21002, name: "ingress_allowed_by", kind: "message", localName: "ingress_allowed_by", repeat: 1 /*RepeatType.PACKED*/, T: () => Policy }
        ]);
    }
    create(value?: PartialMessage<Flow>): Flow {
        ...
        message.reply = false;
        message.traffic_direction = 0;
        message.policy_match_type = 0;
        message.trace_observation_point = 0;
        message.drop_reason_desc = 0;
        message.debug_capture_point = 0;
        message.proxy_port = 0;
        message.sock_xlate_point = 0;
        message.socket_cookie = 0;
        message.cgroup_id = 0;
        message.Summary = "";
        message.egress_allowed_by = [];
        message.ingress_allowed_by = [];
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint32 drop_reason = 3 [deprecated = true];*/ 3:
                    message.drop_reason = reader.uint32();
                    break;
                ...
                case /* repeated string source_names */ 13:
                    message.source_names.push(reader.string());
                    break;
                ...
                case /* flow.CiliumEventType event_type */ 19:
                    message.event_type = CiliumEventType.internalBinaryRead(reader, reader.uint32(), options, message.event_type);
                    break;
                case /* flow.Service source_service */ 20:
                    message.source_service = Service.internalBinaryRead(reader, reader.uint32(), options, message.source_service);
                    break;
                case /* flow.Service destination_service */ 21:
                    message.destination_service = Service.internalBinaryRead(reader, reader.uint32(), options, message.destination_service);
                    break;
                case /* flow.TrafficDirection traffic_direction */ 22:
                    message.traffic_direction = reader.int32();
                    break;
                case /* uint32 policy_match_type */ 23:
                    message.policy_match_type = reader.uint32();
                    break;
                case /* flow.TraceObservationPoint trace_observation_point */ 24:
                    message.trace_observation_point = reader.int32();
                    break;
                case /* flow.DropReason drop_reason_desc */ 25:
                    message.drop_reason_desc = reader.int32();
                    break;
                case /* google.protobuf.BoolValue is_reply */ 26:
                    message.is_reply = BoolValue.internalBinaryRead(reader, reader.uint32(), options, message.is_reply);
                    break;
                case /* flow.DebugCapturePoint debug_capture_point */ 27:
                    message.debug_capture_point = reader.int32();
                    break;
                ...
                case /* uint32 proxy_port */ 29:
                    message.proxy_port = reader.uint32();
                    break;
                case /* flow.TraceContext trace_context */ 30:
                    message.trace_context = TraceContext.internalBinaryRead(reader, reader.uint32(), options, message.trace_context);
                    break;
                case /* flow.SocketTranslationPoint sock_xlate_point */ 31:
                    message.sock_xlate_point = reader.int32();
                    break;
                case /* uint64 socket_cookie */ 32:
                    message.socket_cookie = reader.uint64().toNumber();
                    break;
                case /* uint64 cgroup_id */ 33:
                    message.cgroup_id = reader.uint64().toNumber();
                    break;
                ...
                case /* repeated flow.Policy egress_allowed_by */ 21001:
                    message.egress_allowed_by.push(Policy.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated flow.Policy ingress_allowed_by */ 21002:
                    message.ingress_allowed_by.push(Policy.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
    ...
    internalBinaryWrite(message: Flow, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.drop_reason !== 0)
            writer.tag(3, WireType.Varint).uint32(message.drop_reason);
        /* flow.AuthType auth_type = 35; */
        if (message.auth_type !== 0)
            writer.tag(35, WireType.Varint).int32(message.auth_type);
        ...
        if (message.node_name !== "")
            writer.tag(11, WireType.LengthDelimited).string(message.node_name);
        /* repeated string source_names = 13; */
        for (let i = 0; i < message.source_names.length; i++)
            writer.tag(13, WireType.LengthDelimited).string(message.source_names[i]);
        ...
        if (message.event_type)
            CiliumEventType.internalBinaryWrite(message.event_type, writer.tag(19, WireType.LengthDelimited).fork(), options).join();
        /* flow.Service source_service = 20; */
        if (message.source_service)
            Service.internalBinaryWrite(message.source_service, writer.tag(20, WireType.LengthDelimited).fork(), options).join();
        /* flow.Service destination_service = 21; */
        if (message.destination_service)
            Service.internalBinaryWrite(message.destination_service, writer.tag(21, WireType.LengthDelimited).fork(), options).join();
        /* flow.TrafficDirection traffic_direction = 22; */
        if (message.traffic_direction !== 0)
            writer.tag(22, WireType.Varint).int32(message.traffic_direction);
        /* uint32 policy_match_type = 23; */
        if (message.policy_match_type !== 0)
            writer.tag(23, WireType.Varint).uint32(message.policy_match_type);
        /* flow.TraceObservationPoint trace_observation_point = 24; */
        if (message.trace_observation_point !== 0)
            writer.tag(24, WireType.Varint).int32(message.trace_observation_point);
        /* flow.DropReason drop_reason_desc = 25; */
        if (message.drop_reason_desc !== 0)
            writer.tag(25, WireType.Varint).int32(message.drop_reason_desc);
        /* google.protobuf.BoolValue is_reply = 26; */
        if (message.is_reply)
            BoolValue.internalBinaryWrite(message.is_reply, writer.tag(26, WireType.LengthDelimited).fork(), options).join();
        /* flow.DebugCapturePoint debug_capture_point = 27; */
        if (message.debug_capture_point !== 0)
            writer.tag(27, WireType.Varint).int32(message.debug_capture_point);
        ...
        if (message.proxy_port !== 0)
            writer.tag(29, WireType.Varint).uint32(message.proxy_port);
        /* flow.TraceContext trace_context = 30; */
        if (message.trace_context)
            TraceContext.internalBinaryWrite(message.trace_context, writer.tag(30, WireType.LengthDelimited).fork(), options).join();
        /* flow.SocketTranslationPoint sock_xlate_point = 31; */
        if (message.sock_xlate_point !== 0)
            writer.tag(31, WireType.Varint).int32(message.sock_xlate_point);
        /* uint64 socket_cookie = 32; */
        if (message.socket_cookie !== 0)
            writer.tag(32, WireType.Varint).uint64(message.socket_cookie);
        /* uint64 cgroup_id = 33; */
        if (message.cgroup_id !== 0)
            writer.tag(33, WireType.Varint).uint64(message.cgroup_id);
        ...
        for (let i = 0; i < message.egress_allowed_by.length; i++)
            Policy.internalBinaryWrite(message.egress_allowed_by[i], writer.tag(21001, WireType.LengthDelimited).fork(), options).join();
        /* repeated flow.Policy ingress_allowed_by = 21002; */
        for (let i = 0; i < message.ingress_allowed_by.length; i++)
            Policy.internalBinaryWrite(message.ingress_allowed_by[i], writer.tag(21002, WireType.LengthDelimited).fork(), options).join();
...
class Layer4$Type extends MessageType<Layer4> {
    constructor() {
        super("flow.Layer4", [
            { no: 1, name: "TCP", kind: "message", localName: "TCP", jsonName: "TCP", oneof: "protocol", T: () => TCP },
            { no: 2, name: "UDP", kind: "message", localName: "UDP", jsonName: "UDP", oneof: "protocol", T: () => UDP },
            { no: 3, name: "ICMPv4", kind: "message", localName: "ICMPv4", jsonName: "ICMPv4", oneof: "protocol", T: () => ICMPv4 },
            { no: 4, name: "ICMPv6", kind: "message", localName: "ICMPv6", jsonName: "ICMPv6", oneof: "protocol", T: () => ICMPv6 },
            { no: 5, name: "SCTP", kind: "message", localName: "SCTP", jsonName: "SCTP", oneof: "protocol", T: () => SCTP }
        ]);
    }
...
class Layer7$Type extends MessageType<Layer7> {
    constructor() {
        super("flow.Layer7", [
            ...
            { no: 2, name: "latency_ns", kind: "scalar", localName: "latency_ns", T: 4 /*ScalarType.UINT64*/, L: 2 /*LongType.NUMBER*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint64 latency_ns */ 2:
                    message.latency_ns = reader.uint64().toNumber();
                    break;
    ...
    internalBinaryWrite(message: Layer7, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* uint64 latency_ns = 2; */
        if (message.latency_ns !== 0)
            writer.tag(2, WireType.Varint).uint64(message.latency_ns);
        /* flow.DNS dns = 100; */
...
class TraceParent$Type extends MessageType<TraceParent> {
    constructor() {
        super("flow.TraceParent", [
            { no: 1, name: "trace_id", kind: "scalar", localName: "trace_id", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    ...
    internalBinaryWrite(message: TraceParent, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string trace_id = 1; */
        if (message.trace_id !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.trace_id);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class Endpoint$Type extends MessageType<Endpoint> {
    constructor() {
        super("flow.Endpoint", [
            ...
            { no: 5, name: "pod_name", kind: "scalar", localName: "pod_name", T: 9 /*ScalarType.STRING*/ },
    ...
    internalBinaryWrite(message: Endpoint, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* string pod_name = 5; */
        if (message.pod_name !== "")
            writer.tag(5, WireType.LengthDelimited).string(message.pod_name);
...
class TCP$Type extends MessageType<TCP> {
    constructor() {
        super("flow.TCP", [
            { no: 1, name: "source_port", kind: "scalar", localName: "source_port", T: 13 /*ScalarType.UINT32*/ },
            { no: 2, name: "destination_port", kind: "scalar", localName: "destination_port", T: 13 /*ScalarType.UINT32*/ },
            { no: 3, name: "flags", kind: "message", T: () => TCPFlags }
        ]);
    }
    create(value?: PartialMessage<TCP>): TCP {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.source_port = 0;
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 source_port */ 1:
                    message.source_port = reader.uint32();
                    break;
    ...
    internalBinaryWrite(message: TCP, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.source_port !== 0)
            writer.tag(1, WireType.Varint).uint32(message.source_port);
        /* uint32 destination_port = 2; */
        if (message.destination_port !== 0)
            writer.tag(2, WireType.Varint).uint32(message.destination_port);
...
class TCPFlags$Type extends MessageType<TCPFlags> {
    constructor() {
        super("flow.TCPFlags", [
            { no: 1, name: "FIN", kind: "scalar", localName: "FIN", jsonName: "FIN", T: 8 /*ScalarType.BOOL*/ },
            { no: 2, name: "SYN", kind: "scalar", localName: "SYN", jsonName: "SYN", T: 8 /*ScalarType.BOOL*/ },
            { no: 3, name: "RST", kind: "scalar", localName: "RST", jsonName: "RST", T: 8 /*ScalarType.BOOL*/ },
            { no: 4, name: "PSH", kind: "scalar", localName: "PSH", jsonName: "PSH", T: 8 /*ScalarType.BOOL*/ },
            { no: 5, name: "ACK", kind: "scalar", localName: "ACK", jsonName: "ACK", T: 8 /*ScalarType.BOOL*/ },
            { no: 6, name: "URG", kind: "scalar", localName: "URG", jsonName: "URG", T: 8 /*ScalarType.BOOL*/ },
            { no: 7, name: "ECE", kind: "scalar", localName: "ECE", jsonName: "ECE", T: 8 /*ScalarType.BOOL*/ },
            { no: 8, name: "CWR", kind: "scalar", localName: "CWR", jsonName: "CWR", T: 8 /*ScalarType.BOOL*/ },
            { no: 9, name: "NS", kind: "scalar", localName: "NS", jsonName: "NS", T: 8 /*ScalarType.BOOL*/ }
        ]);
    }
...
class EventTypeFilter$Type extends MessageType<EventTypeFilter> {
    constructor() {
        super("flow.EventTypeFilter", [
            ...
            { no: 2, name: "match_sub_type", kind: "scalar", localName: "match_sub_type", T: 8 /*ScalarType.BOOL*/ },
            { no: 3, name: "sub_type", kind: "scalar", localName: "sub_type", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value?: PartialMessage<EventTypeFilter>): EventTypeFilter {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.type = 0;
        message.match_sub_type = false;
        message.sub_type = 0;
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* bool match_sub_type */ 2:
                    message.match_sub_type = reader.bool();
                    break;
                case /* int32 sub_type */ 3:
                    message.sub_type = reader.int32();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: EventTypeFilter, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.match_sub_type !== false)
            writer.tag(2, WireType.Varint).bool(message.match_sub_type);
        /* int32 sub_type = 3; */
        if (message.sub_type !== 0)
            writer.tag(3, WireType.Varint).int32(message.sub_type);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class CiliumEventType$Type extends MessageType<CiliumEventType> {
    constructor() {
        super("flow.CiliumEventType", [
            { no: 1, name: "type", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 2, name: "sub_type", kind: "scalar", localName: "sub_type", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    ...
    internalBinaryWrite(message: CiliumEventType, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* int32 sub_type = 2; */
        if (message.sub_type !== 0)
            writer.tag(2, WireType.Varint).int32(message.sub_type);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class FlowFilter$Type extends MessageType<FlowFilter> {
    constructor() {
        super("flow.FlowFilter", [
            ...
            { no: 1, name: "source_ip", kind: "scalar", localName: "source_ip", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "source_pod", kind: "scalar", localName: "source_pod", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 7, name: "source_fqdn", kind: "scalar", localName: "source_fqdn", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 10, name: "source_label", kind: "scalar", localName: "source_label", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 16, name: "source_service", kind: "scalar", localName: "source_service", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 26, name: "source_workload", kind: "message", localName: "source_workload", repeat: 1 /*RepeatType.PACKED*/, T: () => Workload },
            { no: 3, name: "destination_ip", kind: "scalar", localName: "destination_ip", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "destination_pod", kind: "scalar", localName: "destination_pod", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 8, name: "destination_fqdn", kind: "scalar", localName: "destination_fqdn", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 11, name: "destination_label", kind: "scalar", localName: "destination_label", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 17, name: "destination_service", kind: "scalar", localName: "destination_service", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 27, name: "destination_workload", kind: "message", localName: "destination_workload", repeat: 1 /*RepeatType.PACKED*/, T: () => Workload },
            { no: 30, name: "traffic_direction", kind: "enum", localName: "traffic_direction", repeat: 1 /*RepeatType.PACKED*/, T: () => ["flow.TrafficDirection", TrafficDirection] },
            { no: 5, name: "verdict", kind: "enum", repeat: 1 /*RepeatType.PACKED*/, T: () => ["flow.Verdict", Verdict] },
            { no: 6, name: "event_type", kind: "message", localName: "event_type", repeat: 1 /*RepeatType.PACKED*/, T: () => EventTypeFilter },
            { no: 9, name: "http_status_code", kind: "scalar", localName: "http_status_code", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 12, name: "protocol", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 13, name: "source_port", kind: "scalar", localName: "source_port", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 14, name: "destination_port", kind: "scalar", localName: "destination_port", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 15, name: "reply", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 8 /*ScalarType.BOOL*/ },
            { no: 18, name: "dns_query", kind: "scalar", localName: "dns_query", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 19, name: "source_identity", kind: "scalar", localName: "source_identity", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ },
            { no: 20, name: "destination_identity", kind: "scalar", localName: "destination_identity", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ },
            { no: 21, name: "http_method", kind: "scalar", localName: "http_method", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 22, name: "http_path", kind: "scalar", localName: "http_path", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 31, name: "http_url", kind: "scalar", localName: "http_url", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 32, name: "http_header", kind: "message", localName: "http_header", repeat: 1 /*RepeatType.PACKED*/, T: () => HTTPHeader },
            { no: 23, name: "tcp_flags", kind: "message", localName: "tcp_flags", repeat: 1 /*RepeatType.PACKED*/, T: () => TCPFlags },
            { no: 24, name: "node_name", kind: "scalar", localName: "node_name", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 25, name: "ip_version", kind: "enum", localName: "ip_version", repeat: 1 /*RepeatType.PACKED*/, T: () => ["flow.IPVersion", IPVersion] },
            { no: 28, name: "trace_id", kind: "scalar", localName: "trace_id", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<FlowFilter>): FlowFilter {
        ...
        message.source_workload = [];
        message.destination_ip = [];
        message.destination_pod = [];
        message.destination_fqdn = [];
        message.destination_label = [];
        message.destination_service = [];
        message.destination_workload = [];
        message.traffic_direction = [];
        message.verdict = [];
        message.event_type = [];
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated string source_ip */ 1:
                    message.source_ip.push(reader.string());
                    break;
                case /* repeated string source_pod */ 2:
                    message.source_pod.push(reader.string());
                    break;
                case /* repeated string source_fqdn */ 7:
                    message.source_fqdn.push(reader.string());
                    break;
                case /* repeated string source_label */ 10:
                    message.source_label.push(reader.string());
                    break;
                case /* repeated string source_service */ 16:
                    message.source_service.push(reader.string());
                    break;
                case /* repeated flow.Workload source_workload */ 26:
                    message.source_workload.push(Workload.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated string destination_ip */ 3:
                    message.destination_ip.push(reader.string());
                    break;
                case /* repeated string destination_pod */ 4:
                    message.destination_pod.push(reader.string());
                    break;
                case /* repeated string destination_fqdn */ 8:
                    message.destination_fqdn.push(reader.string());
                    break;
                case /* repeated string destination_label */ 11:
                    message.destination_label.push(reader.string());
                    break;
                case /* repeated string destination_service */ 17:
                    message.destination_service.push(reader.string());
                    break;
                case /* repeated flow.Workload destination_workload */ 27:
                    message.destination_workload.push(Workload.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated flow.TrafficDirection traffic_direction */ 30:
                    if (wireType === WireType.LengthDelimited)
                        for (let e = reader.int32() + reader.pos; reader.pos < e;)
                            message.traffic_direction.push(reader.int32());
                    else
                        message.traffic_direction.push(reader.int32());
                    break;
                ...
                case /* repeated flow.EventTypeFilter event_type */ 6:
                    message.event_type.push(EventTypeFilter.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated string http_status_code */ 9:
                    message.http_status_code.push(reader.string());
                    break;
                case /* repeated string protocol */ 12:
                    message.protocol.push(reader.string());
                    break;
                case /* repeated string source_port */ 13:
                    message.source_port.push(reader.string());
                    break;
                ...
                case /* repeated string dns_query */ 18:
                    message.dns_query.push(reader.string());
                    break;
                case /* repeated uint32 source_identity */ 19:
                    if (wireType === WireType.LengthDelimited)
                        for (let e = reader.int32() + reader.pos; reader.pos < e;)
                            message.source_identity.push(reader.uint32());
                    else
                        message.source_identity.push(reader.uint32());
                    break;
                case /* repeated uint32 destination_identity */ 20:
                    if (wireType === WireType.LengthDelimited)
                        for (let e = reader.int32() + reader.pos; reader.pos < e;)
                            message.destination_identity.push(reader.uint32());
                    else
                        message.destination_identity.push(reader.uint32());
                    break;
                case /* repeated string http_method */ 21:
                    message.http_method.push(reader.string());
                    break;
                case /* repeated string http_path */ 22:
                    message.http_path.push(reader.string());
                    break;
                case /* repeated string http_url */ 31:
                    message.http_url.push(reader.string());
                    break;
                case /* repeated flow.HTTPHeader http_header */ 32:
                    message.http_header.push(HTTPHeader.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated flow.TCPFlags tcp_flags */ 23:
                    message.tcp_flags.push(TCPFlags.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated string node_name */ 24:
                    message.node_name.push(reader.string());
                    break;
                case /* repeated flow.IPVersion ip_version */ 25:
                    if (wireType === WireType.LengthDelimited)
                        for (let e = reader.int32() + reader.pos; reader.pos < e;)
                            message.ip_version.push(reader.int32());
                    else
                        message.ip_version.push(reader.int32());
                    break;
                case /* repeated string trace_id */ 28:
                    message.trace_id.push(reader.string());
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: FlowFilter, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.source_ip.length; i++)
            writer.tag(1, WireType.LengthDelimited).string(message.source_ip[i]);
        /* repeated string source_pod = 2; */
        for (let i = 0; i < message.source_pod.length; i++)
            writer.tag(2, WireType.LengthDelimited).string(message.source_pod[i]);
        /* repeated string source_fqdn = 7; */
        for (let i = 0; i < message.source_fqdn.length; i++)
            writer.tag(7, WireType.LengthDelimited).string(message.source_fqdn[i]);
        /* repeated string source_label = 10; */
        for (let i = 0; i < message.source_label.length; i++)
            writer.tag(10, WireType.LengthDelimited).string(message.source_label[i]);
        /* repeated string source_service = 16; */
        for (let i = 0; i < message.source_service.length; i++)
            writer.tag(16, WireType.LengthDelimited).string(message.source_service[i]);
        /* repeated flow.Workload source_workload = 26; */
        for (let i = 0; i < message.source_workload.length; i++)
            Workload.internalBinaryWrite(message.source_workload[i], writer.tag(26, WireType.LengthDelimited).fork(), options).join();
        /* repeated string destination_ip = 3; */
        for (let i = 0; i < message.destination_ip.length; i++)
            writer.tag(3, WireType.LengthDelimited).string(message.destination_ip[i]);
        /* repeated string destination_pod = 4; */
        for (let i = 0; i < message.destination_pod.length; i++)
            writer.tag(4, WireType.LengthDelimited).string(message.destination_pod[i]);
        /* repeated string destination_fqdn = 8; */
        for (let i = 0; i < message.destination_fqdn.length; i++)
            writer.tag(8, WireType.LengthDelimited).string(message.destination_fqdn[i]);
        /* repeated string destination_label = 11; */
        for (let i = 0; i < message.destination_label.length; i++)
            writer.tag(11, WireType.LengthDelimited).string(message.destination_label[i]);
        /* repeated string destination_service = 17; */
        for (let i = 0; i < message.destination_service.length; i++)
            writer.tag(17, WireType.LengthDelimited).string(message.destination_service[i]);
        /* repeated flow.Workload destination_workload = 27; */
        for (let i = 0; i < message.destination_workload.length; i++)
            Workload.internalBinaryWrite(message.destination_workload[i], writer.tag(27, WireType.LengthDelimited).fork(), options).join();
        /* repeated flow.TrafficDirection traffic_direction = 30; */
        if (message.traffic_direction.length) {
            writer.tag(30, WireType.LengthDelimited).fork();
            for (let i = 0; i < message.traffic_direction.length; i++)
                writer.int32(message.traffic_direction[i]);
            writer.join();
        }
        ...
        for (let i = 0; i < message.event_type.length; i++)
            EventTypeFilter.internalBinaryWrite(message.event_type[i], writer.tag(6, WireType.LengthDelimited).fork(), options).join();
        /* repeated string http_status_code = 9; */
        for (let i = 0; i < message.http_status_code.length; i++)
            writer.tag(9, WireType.LengthDelimited).string(message.http_status_code[i]);
        ...
        for (let i = 0; i < message.source_port.length; i++)
            writer.tag(13, WireType.LengthDelimited).string(message.source_port[i]);
        /* repeated string destination_port = 14; */
        for (let i = 0; i < message.destination_port.length; i++)
            writer.tag(14, WireType.LengthDelimited).string(message.destination_port[i]);
        ...
        for (let i = 0; i < message.dns_query.length; i++)
            writer.tag(18, WireType.LengthDelimited).string(message.dns_query[i]);
        /* repeated uint32 source_identity = 19; */
        if (message.source_identity.length) {
            writer.tag(19, WireType.LengthDelimited).fork();
            for (let i = 0; i < message.source_identity.length; i++)
                writer.uint32(message.source_identity[i]);
            writer.join();
        }
        /* repeated uint32 destination_identity = 20; */
        if (message.destination_identity.length) {
            writer.tag(20, WireType.LengthDelimited).fork();
            for (let i = 0; i < message.destination_identity.length; i++)
                writer.uint32(message.destination_identity[i]);
            writer.join();
        }
        /* repeated string http_method = 21; */
        for (let i = 0; i < message.http_method.length; i++)
            writer.tag(21, WireType.LengthDelimited).string(message.http_method[i]);
        /* repeated string http_path = 22; */
        for (let i = 0; i < message.http_path.length; i++)
            writer.tag(22, WireType.LengthDelimited).string(message.http_path[i]);
        /* repeated string http_url = 31; */
        for (let i = 0; i < message.http_url.length; i++)
            writer.tag(31, WireType.LengthDelimited).string(message.http_url[i]);
        /* repeated flow.HTTPHeader http_header = 32; */
        for (let i = 0; i < message.http_header.length; i++)
            HTTPHeader.internalBinaryWrite(message.http_header[i], writer.tag(32, WireType.LengthDelimited).fork(), options).join();
        /* repeated flow.TCPFlags tcp_flags = 23; */
        for (let i = 0; i < message.tcp_flags.length; i++)
            TCPFlags.internalBinaryWrite(message.tcp_flags[i], writer.tag(23, WireType.LengthDelimited).fork(), options).join();
        /* repeated string node_name = 24; */
        for (let i = 0; i < message.node_name.length; i++)
            writer.tag(24, WireType.LengthDelimited).string(message.node_name[i]);
        /* repeated flow.IPVersion ip_version = 25; */
        if (message.ip_version.length) {
            writer.tag(25, WireType.LengthDelimited).fork();
            for (let i = 0; i < message.ip_version.length; i++)
                writer.int32(message.ip_version[i]);
            writer.join();
        }
        /* repeated string trace_id = 28; */
        for (let i = 0; i < message.trace_id.length; i++)
            writer.tag(28, WireType.LengthDelimited).string(message.trace_id[i]);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class DNS$Type extends MessageType<DNS> {
    constructor() {
        super("flow.DNS", [
            ...
            { no: 5, name: "observation_source", kind: "scalar", localName: "observation_source", T: 9 /*ScalarType.STRING*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string observation_source */ 5:
                    message.observation_source = reader.string();
                    break;
                case /* uint32 rcode */ 6:
    ...
    internalBinaryWrite(message: DNS, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.observation_source !== "")
            writer.tag(5, WireType.LengthDelimited).string(message.observation_source);
        /* uint32 rcode = 6; */
        if (message.rcode !== 0)
...
class Kafka$Type extends MessageType<Kafka> {
    constructor() {
        super("flow.Kafka", [
            { no: 1, name: "error_code", kind: "scalar", localName: "error_code", T: 5 /*ScalarType.INT32*/ },
            { no: 2, name: "api_version", kind: "scalar", localName: "api_version", T: 5 /*ScalarType.INT32*/ },
            { no: 3, name: "api_key", kind: "scalar", localName: "api_key", T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "correlation_id", kind: "scalar", localName: "correlation_id", T: 5 /*ScalarType.INT32*/ },
    ...
    internalBinaryWrite(message: Kafka, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.error_code !== 0)
            writer.tag(1, WireType.Varint).int32(message.error_code);
        /* int32 api_version = 2; */
        if (message.api_version !== 0)
            writer.tag(2, WireType.Varint).int32(message.api_version);
        /* string api_key = 3; */
        if (message.api_key !== "")
            writer.tag(3, WireType.LengthDelimited).string(message.api_key);
        /* int32 correlation_id = 4; */
        if (message.correlation_id !== 0)
            writer.tag(4, WireType.Varint).int32(message.correlation_id);
        /* string topic = 5; */
        if (message.topic !== "")
...
class LostEvent$Type extends MessageType<LostEvent> {
    constructor() {
        super("flow.LostEvent", [
            ...
            { no: 2, name: "num_events_lost", kind: "scalar", localName: "num_events_lost", T: 4 /*ScalarType.UINT64*/, L: 2 /*LongType.NUMBER*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint64 num_events_lost */ 2:
                    message.num_events_lost = reader.uint64().toNumber();
                    break;
    ...
    internalBinaryWrite(message: LostEvent, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.num_events_lost !== 0)
            writer.tag(2, WireType.Varint).uint64(message.num_events_lost);
...
class AgentEvent$Type extends MessageType<AgentEvent> {
    constructor() {
        super("flow.AgentEvent", [
            ...
            { no: 101, name: "agent_start", kind: "message", localName: "agent_start", oneof: "notification", T: () => TimeNotification },
            { no: 102, name: "policy_update", kind: "message", localName: "policy_update", oneof: "notification", T: () => PolicyUpdateNotification },
            { no: 103, name: "endpoint_regenerate", kind: "message", localName: "endpoint_regenerate", oneof: "notification", T: () => EndpointRegenNotification },
            { no: 104, name: "endpoint_update", kind: "message", localName: "endpoint_update", oneof: "notification", T: () => EndpointUpdateNotification },
            { no: 105, name: "ipcache_update", kind: "message", localName: "ipcache_update", oneof: "notification", T: () => IPCacheNotification },
            { no: 106, name: "service_upsert", kind: "message", localName: "service_upsert", oneof: "notification", T: () => ServiceUpsertNotification },
            { no: 107, name: "service_delete", kind: "message", localName: "service_delete", oneof: "notification", T: () => ServiceDeleteNotification }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* flow.TimeNotification agent_start */ 101:
                    message.notification = {
                        oneofKind: "agent_start",
                        agent_start: TimeNotification.internalBinaryRead(reader, reader.uint32(), options, (message.notification as any).agent_start)
                    };
                    break;
                case /* flow.PolicyUpdateNotification policy_update */ 102:
                    message.notification = {
                        oneofKind: "policy_update",
                        policy_update: PolicyUpdateNotification.internalBinaryRead(reader, reader.uint32(), options, (message.notification as any).policy_update)
                    };
                    break;
                case /* flow.EndpointRegenNotification endpoint_regenerate */ 103:
                    message.notification = {
                        oneofKind: "endpoint_regenerate",
                        endpoint_regenerate: EndpointRegenNotification.internalBinaryRead(reader, reader.uint32(), options, (message.notification as any).endpoint_regenerate)
                    };
                    break;
                case /* flow.EndpointUpdateNotification endpoint_update */ 104:
                    message.notification = {
                        oneofKind: "endpoint_update",
                        endpoint_update: EndpointUpdateNotification.internalBinaryRead(reader, reader.uint32(), options, (message.notification as any).endpoint_update)
                    };
                    break;
                case /* flow.IPCacheNotification ipcache_update */ 105:
                    message.notification = {
                        oneofKind: "ipcache_update",
                        ipcache_update: IPCacheNotification.internalBinaryRead(reader, reader.uint32(), options, (message.notification as any).ipcache_update)
                    };
                    break;
                case /* flow.ServiceUpsertNotification service_upsert */ 106:
                    message.notification = {
                        oneofKind: "service_upsert",
                        service_upsert: ServiceUpsertNotification.internalBinaryRead(reader, reader.uint32(), options, (message.notification as any).service_upsert)
                    };
                    break;
                case /* flow.ServiceDeleteNotification service_delete */ 107:
                    message.notification = {
                        oneofKind: "service_delete",
                        service_delete: ServiceDeleteNotification.internalBinaryRead(reader, reader.uint32(), options, (message.notification as any).service_delete)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: AgentEvent, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.notification.oneofKind === "agent_start")
            TimeNotification.internalBinaryWrite(message.notification.agent_start, writer.tag(101, WireType.LengthDelimited).fork(), options).join();
        /* flow.PolicyUpdateNotification policy_update = 102; */
        if (message.notification.oneofKind === "policy_update")
            PolicyUpdateNotification.internalBinaryWrite(message.notification.policy_update, writer.tag(102, WireType.LengthDelimited).fork(), options).join();
        /* flow.EndpointRegenNotification endpoint_regenerate = 103; */
        if (message.notification.oneofKind === "endpoint_regenerate")
            EndpointRegenNotification.internalBinaryWrite(message.notification.endpoint_regenerate, writer.tag(103, WireType.LengthDelimited).fork(), options).join();
        /* flow.EndpointUpdateNotification endpoint_update = 104; */
        if (message.notification.oneofKind === "endpoint_update")
            EndpointUpdateNotification.internalBinaryWrite(message.notification.endpoint_update, writer.tag(104, WireType.LengthDelimited).fork(), options).join();
        /* flow.IPCacheNotification ipcache_update = 105; */
        if (message.notification.oneofKind === "ipcache_update")
            IPCacheNotification.internalBinaryWrite(message.notification.ipcache_update, writer.tag(105, WireType.LengthDelimited).fork(), options).join();
        /* flow.ServiceUpsertNotification service_upsert = 106; */
        if (message.notification.oneofKind === "service_upsert")
            ServiceUpsertNotification.internalBinaryWrite(message.notification.service_upsert, writer.tag(106, WireType.LengthDelimited).fork(), options).join();
        /* flow.ServiceDeleteNotification service_delete = 107; */
        if (message.notification.oneofKind === "service_delete")
            ServiceDeleteNotification.internalBinaryWrite(message.notification.service_delete, writer.tag(107, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class PolicyUpdateNotification$Type extends MessageType<PolicyUpdateNotification> {
    constructor() {
        super("flow.PolicyUpdateNotification", [
            ...
            { no: 3, name: "rule_count", kind: "scalar", localName: "rule_count", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 rule_count */ 3:
                    message.rule_count = reader.int64().toNumber();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: PolicyUpdateNotification, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* int64 rule_count = 3; */
        if (message.rule_count !== 0)
            writer.tag(3, WireType.Varint).int64(message.rule_count);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class EndpointUpdateNotification$Type extends MessageType<EndpointUpdateNotification> {
    constructor() {
        super("flow.EndpointUpdateNotification", [
            ...
            { no: 2, name: "labels", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "error", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "pod_name", kind: "scalar", localName: "pod_name", T: 9 /*ScalarType.STRING*/ },
    ...
    internalBinaryWrite(message: EndpointUpdateNotification, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* string pod_name = 4; */
        if (message.pod_name !== "")
            writer.tag(4, WireType.LengthDelimited).string(message.pod_name);
        /* string namespace = 5; */
        if (message.namespace !== "")
...
class IPCacheNotification$Type extends MessageType<IPCacheNotification> {
    constructor() {
        super("flow.IPCacheNotification", [
            ...
            { no: 2, name: "identity", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 3, name: "old_identity", kind: "message", localName: "old_identity", T: () => UInt32Value },
            { no: 4, name: "host_ip", kind: "scalar", localName: "host_ip", T: 9 /*ScalarType.STRING*/ },
            { no: 5, name: "old_host_ip", kind: "scalar", localName: "old_host_ip", T: 9 /*ScalarType.STRING*/ },
            { no: 6, name: "encrypt_key", kind: "scalar", localName: "encrypt_key", T: 13 /*ScalarType.UINT32*/ },
            { no: 7, name: "namespace", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 8, name: "pod_name", kind: "scalar", localName: "pod_name", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.protobuf.UInt32Value old_identity */ 3:
                    message.old_identity = UInt32Value.internalBinaryRead(reader, reader.uint32(), options, message.old_identity);
                    break;
                case /* string host_ip */ 4:
                    message.host_ip = reader.string();
                    break;
                case /* string old_host_ip */ 5:
                    message.old_host_ip = reader.string();
                    break;
                case /* uint32 encrypt_key */ 6:
                    message.encrypt_key = reader.uint32();
                    break;
    ...
    internalBinaryWrite(message: IPCacheNotification, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.old_identity)
            UInt32Value.internalBinaryWrite(message.old_identity, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* string host_ip = 4; */
        if (message.host_ip !== "")
            writer.tag(4, WireType.LengthDelimited).string(message.host_ip);
        /* string old_host_ip = 5; */
        if (message.old_host_ip !== "")
            writer.tag(5, WireType.LengthDelimited).string(message.old_host_ip);
        /* uint32 encrypt_key = 6; */
        if (message.encrypt_key !== 0)
            writer.tag(6, WireType.Varint).uint32(message.encrypt_key);
        /* string namespace = 7; */
        if (message.namespace !== "")
            writer.tag(7, WireType.LengthDelimited).string(message.namespace);
        /* string pod_name = 8; */
        if (message.pod_name !== "")
            writer.tag(8, WireType.LengthDelimited).string(message.pod_name);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class ServiceUpsertNotification$Type extends MessageType<ServiceUpsertNotification> {
    constructor() {
        super("flow.ServiceUpsertNotification", [
            ...
            { no: 2, name: "frontend_address", kind: "message", localName: "frontend_address", T: () => ServiceUpsertNotificationAddr },
            { no: 3, name: "backend_addresses", kind: "message", localName: "backend_addresses", repeat: 1 /*RepeatType.PACKED*/, T: () => ServiceUpsertNotificationAddr },
            { no: 4, name: "type", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 5, name: "traffic_policy", kind: "scalar", localName: "traffic_policy", T: 9 /*ScalarType.STRING*/ },
            { no: 6, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 7, name: "namespace", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 8, name: "ext_traffic_policy", kind: "scalar", localName: "ext_traffic_policy", T: 9 /*ScalarType.STRING*/ },
            { no: 9, name: "int_traffic_policy", kind: "scalar", localName: "int_traffic_policy", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<ServiceUpsertNotification>): ServiceUpsertNotification {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.id = 0;
        message.backend_addresses = [];
        message.type = "";
        message.traffic_policy = "";
        message.name = "";
        message.namespace = "";
        message.ext_traffic_policy = "";
        message.int_traffic_policy = "";
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* flow.ServiceUpsertNotificationAddr frontend_address */ 2:
                    message.frontend_address = ServiceUpsertNotificationAddr.internalBinaryRead(reader, reader.uint32(), options, message.frontend_address);
                    break;
                case /* repeated flow.ServiceUpsertNotificationAddr backend_addresses */ 3:
                    message.backend_addresses.push(ServiceUpsertNotificationAddr.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* string type */ 4:
                    message.type = reader.string();
                    break;
                case /* string traffic_policy = 5 [deprecated = true];*/ 5:
                    message.traffic_policy = reader.string();
                    break;
                case /* string name */ 6:
                    message.name = reader.string();
                    break;
                ...
                case /* string ext_traffic_policy */ 8:
                    message.ext_traffic_policy = reader.string();
                    break;
                case /* string int_traffic_policy */ 9:
                    message.int_traffic_policy = reader.string();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: ServiceUpsertNotification, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.frontend_address)
            ServiceUpsertNotificationAddr.internalBinaryWrite(message.frontend_address, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* repeated flow.ServiceUpsertNotificationAddr backend_addresses = 3; */
        for (let i = 0; i < message.backend_addresses.length; i++)
            ServiceUpsertNotificationAddr.internalBinaryWrite(message.backend_addresses[i], writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* string type = 4; */
        if (message.type !== "")
            writer.tag(4, WireType.LengthDelimited).string(message.type);
        /* string traffic_policy = 5 [deprecated = true]; */
        if (message.traffic_policy !== "")
            writer.tag(5, WireType.LengthDelimited).string(message.traffic_policy);
        /* string name = 6; */
        if (message.name !== "")
        ...
        if (message.ext_traffic_policy !== "")
            writer.tag(8, WireType.LengthDelimited).string(message.ext_traffic_policy);
        /* string int_traffic_policy = 9; */
        if (message.int_traffic_policy !== "")
            writer.tag(9, WireType.LengthDelimited).string(message.int_traffic_policy);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
